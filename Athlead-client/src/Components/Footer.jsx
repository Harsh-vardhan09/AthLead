...
const Footer = () => {
  return (
    <footer class="bg-[#1D2530] basic mx-5 border-t border-gray-200/20 ">
    <div class="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="" class="flex items-center">
                  <span class="text-4xl font-bold bg-linear-to-r from-teal-600 via-teal-900 to-blue-400 bg-clip-text text-transparent">Athlead</span>
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul class="text-body font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Athlead</a>
                      </li>
                      <li>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© 2025 <a href="https://flowbite.com/" class="hover:underline">AthLead™</a>. All Rights Reserved.
          </span>
