...
export const BentoGridItem = ({
  ...
  return (
    <a
      ...
      className={cn(
        "group/bento shadow-input row-span-1 flex flex-col justify-between space-y-4 rounded-xl bg-linear-to-br from-[#0f2027] via-[#1a3a4a] to-[#0f2027]  border border-[rgba(6,182,212,0.2)] hover:shadow-[0_0_60px_rgba(6,182,212,0.10)] p-4 transition duration-200 cursor-pointer",
        className,
      )}
    >
      {header}
      <div className=" relative transition duration-200 group-hover/bento:translate-z-2">
        <img src={image} alt={title} className="rounded-lg w-full h-48" />
