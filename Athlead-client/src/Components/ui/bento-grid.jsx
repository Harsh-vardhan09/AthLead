...
export const BentoGridItem = ({ className, title, header, image, link }) => {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div className=" relative transition duration-200 group-hover/bento:translate-z-2">
        ...
        <div
          ...
          className="absolute top-3 left-6 font-sans text-xs font-normal text-neutral-300 opacity-0 transition-opacity group-hover/bento:opacity-100"
        >
          <ExternalLink />
        </div>
      </div>
