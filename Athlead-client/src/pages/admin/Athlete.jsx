...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span
      className={`px-2.5 py-1 text-xs font-medium rounded-full border ${styles[status] || styles.Inactive}`}
    >
      {status}
    </span>
  );
      ...
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            View, search, and manage athlete profiles and scores.
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          ...
          <div className="relative flex-shrink-0">
            ...
            <select
              value={statusFilter}
              aria-label="Filter athletes by status"
              ...
              <div className="flex justify-between items-start">
                <div className="relative">
                  <img
                    ...
                    className="w-14 h-14 rounded-full object-cover ring-2 ring-slate-100 group-hover:ring-indigo-100 transition-all"
                  />
                  <div
                    className={`absolute bottom-0 right-0 w-3.5 h-3.5 rounded-full border-2 border-white ${athlete.status === "Active" ? "bg-emerald-500" : athlete.status === "Injured" ? "bg-amber-500" : "bg-slate-400"}`}
                  ></div>
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-semibold text-slate-700">
                      {athlete.scoreSummary.potentialScore}
                    </span>
                  </div>
                </div>
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="font-semibold text-slate-700">
                      #{athlete.scoreSummary.currentRank}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-end gap-6">
                ...
                <div className="mb-2">
                  ...
                  <p className="text-indigo-100 flex items-center gap-2 text-sm">
                    <MapPin size={16} /> {selectedAthlete.state} &bull;{" "}
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 relative z-10">
                ...
                <div className="flex flex-col items-center justify-center p-4 bg-indigo-50 rounded-xl text-indigo-900">
                  ...
                  <span className="text-3xl font-bold">
                    {selectedAthlete.scoreSummary.potentialScore}
                  </span>
                  <span className="text-xs font-medium uppercase tracking-wider text-indigo-600/70 mt-1">
                    Potential Score
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center justify-center p-4 bg-amber-50 rounded-xl text-amber-900">
                  ...
                  <span className="text-3xl font-bold">
                    #{selectedAthlete.scoreSummary.currentRank}
                  </span>
                  <span className="text-xs font-medium uppercase tracking-wider text-amber-600/70 mt-1">
                    Current Rank
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center justify-center p-4 bg-emerald-50 rounded-xl text-emerald-900">
                  ...
                  <span className="text-3xl font-bold">
                    {selectedAthlete.scoreSummary.trend}
                  </span>
                  <span className="text-xs font-medium uppercase tracking-wider text-emerald-600/70 mt-1">
                    Recent Trend
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center gap-2">
                    <Info className="text-slate-400" size={20} /> Account
                    Details
                  </h3>
